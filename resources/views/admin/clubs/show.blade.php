            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>@lang('quickadmin.clubs.fields.title')</th>
                            <td field-key='title'>{{ $club->title }}</td>
                        </tr>
                    </table>
                </div>
            </div><!-- Nav tabs -->
...
<li role="presentation" class="active"><a href="#coaches" aria-controls="coaches" role="tab" data-toggle="tab">Treneriai</a></li>
<li role="presentation" class=""><a href="#kids" aria-controls="kids" role="tab" data-toggle="tab">Vaikai</a></li>
</ul>

<!-- Tab panes -->
<div class="tab-content">
    
<div role="tabpanel" class="tab-pane active" id="coaches">
                    ...
                    <td field-key='name'>{{ $coach->name }}</td>
                                ...
                                <td>
                                    @can('delete')
                                        ...
                                        'route' => ['coaches.restore', $coach->id])) !!}
                                ...
                                @endcan
                                    @can('delete')
                                        ...
                                        'method' => 'DELETE',
                                        'onsubmit' => "return confirm('".trans("quickadmin.qa_are_you_sure")."');",
                                        'route' => ['coaches.perma_del', $coach->id])) !!}
                                ...
                                <td>
                                    @can('view')
                                    <a href="{{ route('coaches.show',[$coach->id]) }}" class="btn btn-xs btn-primary">@lang('quickadmin.qa_view')</a>
                                    @endcan
                                    @can('edit')
                                    <a href="{{ route('coaches.edit',[$coach->id]) }}" class="btn btn-xs btn-info">@lang('quickadmin.qa_edit')</a>
                                    @endcan
                                    @can('delete')
{!! Form::open(array(
                                        'style' => 'display: inline-block;',
