...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.kids.store']]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('ifsc_licence', trans('IFSC licencija'), ['class' => 'control-label']) !!}
                    {!! Form::hidden('ifsc_licence', 0) !!}
                    {!! Form::checkbox('ifsc_licence', 1, false) !!}
                    <p class="help-block"></p>
